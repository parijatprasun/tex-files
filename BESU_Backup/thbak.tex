...
%\begin{figure}[h]
%\centering
%\includegraphics[width=155mm]{frbd}
...
%\begin{figure}[h]
%\centering
%\includegraphics[width=155mm]{mysignal}
...
%\section{Applications of MFS}
%\begin{enumerate}
%\item Balance training
%\item Shaft alignment training and alignment system assessment		
%\item Coupling studies
%\item Bearing Faults and loading effects
%\item ``Cocked'' rotor
%\item Eccentric rotor Modal Analysis
%\item Resonance studies
%\item Sleeve bearing studies optimum location
%\item Belt drive performance
%\item Mechanical looseness
%\item Bent shaft certification
%\item Mechanical rub
%\item Gearbox fault studies dynamics studies and demonstration
%\item Reciprocating mechanism studies
%\item Foundation studies
%\item Signal processing issues
%\item Variable speed machinery
%\item High speed and low speed operation
%\item Motor current analysis
%\item Rotor dynamics
%\item Operating Deflection Shape and
%\item Sensor mounting techniques and
%\item Sensor types (prox probes, etc.)
%\item Overall vibration training and analyst
%\item Customised test bed for rotor
%\end{enumerate}
